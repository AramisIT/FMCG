...
//            if (IsAnswerIsTrue)
//                {
//                Data.Count = new PlaningData<double>(Convert.ToDouble(ResultParameters[1]));
//                Data.Goods = ResultParameters[2].ToString();
//                Data.Date = ResultParameters[3].ToString();
//                Data.PalletId = Convert.ToInt64(ResultParameters[4]);
//                Data.Measure = ResultParameters[5].ToString();
//                Data.DocInfo = new KeyValuePair<long, long>(Convert.ToInt64(ResultParameters[6]),
//                                                            Convert.ToInt64(ResultParameters[7]));
//                Data.Cell = new KeyValuePair<long, string>(Convert.ToInt64(ResultParameters[8]), Parameters[9].ToString());
