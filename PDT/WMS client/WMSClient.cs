...
namespace WMS_client
    ...
    public class WMSClient
        ...
        public void Start()
            ...
            try
                {
                ConnectionAgent = new ServerAgent(ServerIP, 8609, this, MainForm.DrawConnectionStatus,
                                                  MainForm.ShowPingResult);
                }
            catch (Exception exp)
                {
                MessageBox.Show(
                    string.Format(
                        "Ошибка создания агента сервера. Server IP = {0}\r\nОписание ошибки:\r\n{1}\r\nПриложение будет закрыто!",
                        ServerIP, exp.Message));
                Application.Exit();
                }
